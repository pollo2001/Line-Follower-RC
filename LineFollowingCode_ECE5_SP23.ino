...
void ReadPotentiometers() {
  ...
  SpRead = ReadPotentiometerHelper(S_pin, 0, 1023, 0, 200); // We want to read a potentiometer for S_pin with resolution from 0 to 1023 and potentiometer range from 0 to 100.
